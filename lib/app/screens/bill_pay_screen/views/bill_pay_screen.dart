...
import 'package:ovopay/app/screens/bill_pay_screen/views/widgets/bill_pay_amount_page.dart';
import 'package:ovopay/app/screens/bill_pay_screen/views/widgets/bill_pay_dynamic_form_page.dart';
import 'package:ovopay/app/screens/bill_pay_screen/views/widgets/bill_pay_select_bill_type_page.dart';
import 'package:ovopay/core/data/repositories/modules/bill_pay/bill_pay_repo.dart';
import 'package:ovopay/core/route/route.dart';

import '../../../../../core/utils/util_exporter.dart';
import 'widgets/bill_pay_pin_page.dart';
    ...
    return MyCustomScaffold(
      ...
      actionButton: [
        if (_currentPage == 0)
          CustomAppCard(
            onPressed: () {
              Get.toNamed(RouteHelper.billPayHistoryScreen);
            },
      ...
      pageTitle: _currentPage == 4 ? MyStrings.payBill : MyStrings.billPay,
      body: PageView(
        ...
        children: [
          BillPaySelectBillTypePageWidget(
            context: context,
            onSuccessCallback: () {
              _nextPage(goToPage: 1);
            },
          ),
          BillPayDynamicFormPage(
            context: context,
            onSuccessCallback: () {
          ...
          BillPayPinVerificationPage(context: context),
        ],
      ),
    );
  }
