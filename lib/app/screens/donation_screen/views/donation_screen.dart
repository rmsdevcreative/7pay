...
import 'package:ovopay/app/screens/donation_screen/views/widgets/donation_dynamic_form_page.dart';
import 'package:ovopay/app/screens/donation_screen/views/widgets/donation_select_organization_type_page.dart';

import 'package:ovopay/core/data/repositories/modules/donation/donation_repo.dart';
import 'package:ovopay/core/route/route.dart';

import '../../../../../core/utils/util_exporter.dart';
import 'widgets/donation_pin_page.dart';
    ...
    return MyCustomScaffold(
      ...
      actionButton: [
        if (_currentPage == 0)
          CustomAppCard(
            onPressed: () {
              Get.toNamed(RouteHelper.donationHistoryScreen);
            },
      ...
      body: PageView(
        ...
        children: [
          DonationSelectOrganizationTypePageWidget(
            context: context,
            onSuccessCallback: () {
              _nextPage(goToPage: 1);
            },
          ),
          DonationDynamicFormPage(
            context: context,
            onSuccessCallback: () {
              _nextPage(goToPage: 2);
            },
          ),
          DonationPinVerificationPage(context: context),
        ],
      ),
    );
  }
