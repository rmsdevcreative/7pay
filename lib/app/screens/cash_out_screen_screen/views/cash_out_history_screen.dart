...
class _CashOutHistoryScreenState extends State<CashOutHistoryScreen> {
  ...
  void fetchData() {
    Get.find<CashOutController>().getCashOutHistoryDataList(forceLoad: false);
  }
    ...
    return GetBuilder<CashOutController>(
      builder: (controller) {
        return MyCustomScaffold(
          pageTitle: MyStrings.cashOutHistory,
          body: CustomAppCard(
            child: Column(
              ...
              children: [
                Flexible(
                  ...
                  child: controller.isHistoryLoading
                      ...
                      : (controller.cashOutHistoryList.isEmpty)
                          ...
                          : RefreshIndicator(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  var item = controller.cashOutHistoryList[index];
                                  bool isLastIndex = index == controller.cashOutHistoryList.length - 1;
                                  return CustomCompanyListTileCard(
                                    ...
                                    subtitle: MyStrings.cashOutMessage.tr.rKv({
  ...
  Widget buildDetailsSectionSheet({
    required LatestCashOutHistory item,
            ...
            children: [
              Expanded(
                child: CardColumn(
                  ...
                  body: "+${item.receiverAgent?.getUserMobileNo(withCountryCode: true) ?? ""}",
                  space: 5,
                  crossAxisAlignment: CrossAxisAlignment.start,
                ),
              ),
